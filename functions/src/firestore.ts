export const AdminCollection = "_Admin";
export const UsersStats = "--users stats--";
export const SpacesStats = "--spaces stats--";
export const PlantsStats = "--plants stats--";
export const SpeciesStats = "--species stats--";
